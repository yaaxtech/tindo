...
test('no mutation without evidence; complete trial changes real default once and leaves rollback receipt',()=>{
 ...
 const cfg={_meta:{auto_aplicar:true,governanca:'experimentos-v1'},codex:{terrenos:{rotina:{modelo:'sol',effort:'low',experimento:{id:'test-v1',ativo:true,base:'a',bracos:[{id:'a',modelo:'sol',effort:'low'},{id:'b',modelo:'luna',effort:'max'}]}}}}};
 ...
 for(const [arm,modelo,effort,tokens] of [['a','sol','low',100],['b','luna','max',50]])for(let i=0;i<100;i++){
  ...
  linhas.push({frente:'codex',terreno:'rotina',papel:'construtor',auto:true,experiment_version:versaoExperimento(cfg.codex.terrenos.rotina.experimento),modelo_confirmado:true,experiment_id:'test-v1',arm,modelo,effort,resultado:'ok1',session_id,dur:1});
 }
