...
export const GET = rotaApi('GET /api/adiamento/sugerir', async (request: NextRequest) => {
  ...
  if (!tarefa) throw new ErroNaoEncontrado('Tarefa não encontrada');
