import { rotaApi } from '@/lib/api/resposta';
...
// Download de arquivo: a resposta de SUCESSO é um `Response` cru com
// Content-Disposition, não o envelope JSON. Só o caminho de ERRO usa o kernel,
// que loga o detalhe técnico e devolve `{ erro, codigo }` genérico.
export const GET = rotaApi('GET /api/todoist/backup', async () => {
