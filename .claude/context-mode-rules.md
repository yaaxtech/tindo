...
> **Condicional:** estas regras só valem SE as tools `ctx_*` estiverem conectadas nesta sessão. Se não aparecerem (ex.: plugin instalado em outro cwd), ignore este arquivo e use Bash/Read/Grep/WebFetch normalmente. As afirmações abaixo de 'curl/WebFetch BLOQUEADOS' NÃO valem quando o plugin está inativo.
